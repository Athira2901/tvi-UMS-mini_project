...
function Buyproduct(props) {
  ...
  // function getsingleaddress(address){
  //   console.log("getsingle=",address)
  // }
  return (
        ...
        <div className="mt-3  shadow-xl">
          <div className="flex justify-between mt-3 ">
            <div>
              ...
              <div className="bg-[darkorange] w-[120px] h-[40px] text-center flex justify-center  rounded-md ml-[400px] mt-5">
